...
<img src="img/IM150209BN014-zelfrijdende-vrachtwagen-1000x500-1000x500.jpg" alt="Mountain View" style="width:603px;height:470px">
<section class="Regions">
<p>Parking Lots Status</p>
<p class="status">Red ==> Reserved/Booked , Yellow ==> Available</p>
<!-- Table goes in the document BODY -->
<table class="gridtable">
<?php $street ="IDP STREET"; ?>
<tr>
	<td <?php 
