...
else
{
		...
		$query="INSERT INTO `transactions`(street,plot,status,model,vehicle,platenumber,email,account,d1,d2,charge) VALUES ('$street', '$plot', '$status', '$model', '$vehicle', '$plateno', '$email', '$account', '$from', '$to', '$charge')";
		$result = mysql_query($query);
		$var = $_SESSION["from"];
