...
<img src="img/parking2.jpg" alt="Mountain View" style="width:954px;height:470px">
...
<hr>
  <form action="process-sign-up.php" method="post">
	 ...
	 <input type="text" name="phone" placeholder=" your phonenumber" id="FullName"required pattern="(\+?\d[- .]*){7,13}" title="phone number" maxlength="10"/> 
